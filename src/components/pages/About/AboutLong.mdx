...
After helping design and build the product – which is still used to the day – I decided to step back from day-to-day operations to focus on JAM and other projects, while continuing to support from afar. 
